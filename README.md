# dhcp
[![Build Status](https://img.shields.io/github/actions/workflow/status/cuityhj/dhcp/tests.yml?branch=master)](https://github.com/cuityhj/dhcp/actions?query=branch%3Amaster)
[![GoDoc](https://godoc.org/github.com/cuityhj/dhcp?status.svg)](https://godoc.org/github.com/cuityhj/dhcp)
[![codecov](https://codecov.io/gh/cuityhj/dhcp/branch/master/graph/badge.svg)](https://codecov.io/gh/cuityhj/dhcp)
[![Go Report Card](https://goreportcard.com/badge/github.com/cuityhj/dhcp)](https://goreportcard.com/report/github.com/cuityhj/dhcp)
...
```
go get -u github.com/cuityhj/dhcp/dhcpv{4,6}
```
